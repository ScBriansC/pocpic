...
var opt;
    ...
    function filtrar(){
        ...
        SipcopJS.post('admin/reporte/json_consultar_detuvo',{
    ...
    function modalDetalle(dependencia,nivel,fecha,periodo){
        ...
        SipcopJS.post('admin/reporte/json_consultar_detuvo_det',{
    ...
    function cargarData(reporte){
        ...
        opt = {
            ...
            title: {
                text: 'Reporte de vehiculos detenidos'
            },
            xAxis: {
    ...
    $('#btnExportarDet').click(function(){
        SipcopJS.autoPostBlank('admin/reporte/json_consultar_detuvo_det_xls', {
    ...
    $('#btnExportar').click(function(){
        var dependencia = SipcopJS.get_dependencia('#txtMacroReg', '#txtRegPol', '#txtDivTer', '#txtComisaria');
        SipcopJS.autoPostBlank('admin/reporte/json_consultar_detuvo_xls', {
            fechaini: $('#dpFechaIni').data('datepicker').obtenerFecha($('#txtPeriodo').val(),'ini'), 
            fechafin: $('#dpFechaFin').data('datepicker').obtenerFecha($('#txtPeriodo').val(),'fin'),  
            periodo: $('#txtPeriodo').val(),
            tipo: dependencia.tipo,
    ...
    <div class="col-sm-12">
        <section class="panel">
            <header class="panel-heading">
                Reporte de vehículos detenidos
            </header>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 id="basicModalLabel" class="modal-title">Detalle de vehículos detenidos &nbsp;&nbsp;&nbsp;
