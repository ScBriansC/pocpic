...
var opt;
    ...
    function filtrar(){
        ...
        SipcopJS.post('admin/reporte/rpt_consultar_salio',{
    ...
    function modalDetalle(dependencia,nivel,fecha,periodo){
        ...
        SipcopJS.post('admin/reporte/rpt_salio_det',{
    ...
    function cargarData(reporte){
        ...
        opt = {
            ...
            title: {
                text: 'Reporte de vehículos que salieron de su jurisdicción'
            },
            xAxis: {
            ...
            yAxis: {
                min: 0,
                title: {
                    text: '# Vehículos que salieron de su jurisdicción'
                }
            },
            tooltip: {
    ...
    preCarga = function(){
      $('#dgTabla').dataTable({
          ...
          "aoColumns": [
            ...
            {sTitle : "Ratio Veces", mData: "RptRatioVeces"},
    ...
    $('#txtMacroReg').change(function(){
      ...
      $('#btnFiltrar').click(function(){
       ...
       $('#btnExportar').click(function(){
        var dependencia = SipcopJS.get_dependencia('#txtMacroReg', '#txtRegPol', '#txtDivTer', '#txtComisaria');
        SipcopJS.autoPostBlank('admin/reporte/rpt_consultar_salio_xls', {
            fechaini: $('#dpFechaIni').data('datepicker').obtenerFecha($('#txtPeriodo').val(),'ini'), 
            fechafin: $('#dpFechaFin').data('datepicker').obtenerFecha($('#txtPeriodo').val(),'fin'),  
            periodo: $('#txtPeriodo').val(),
            tipo: dependencia.tipo,
    ...
    $('#btnExportarDet').click(function(){
        SipcopJS.autoPostBlank('admin/reporte/rpt_salio_det_xls', {
    ...
    <div class="col-sm-12">
        <section class="panel">
            <header class="panel-heading">
                Reporte de vehículos que salieron de su jurisdicción
            </header>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 id="basicModalLabel" class="modal-title">DETALLE DE VEHÍCULOS QUE SALIERON DE SU JURISDICCIÓN &nbsp;&nbsp;&nbsp;
