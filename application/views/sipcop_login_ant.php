                    ...
                    <div class="card p-4">
                        <div class="card-block">
                            <form id="frmLogin" method="post" autocomplete="off">
                                <p class="text-muted" align="center"><img src="assets/images/logo-login.png" width="250" /></p>
                        ...
                        <div class="navegador" style="border-top: 1px solid rgb(176, 184, 187);color: #425669;font-weight: 700;">
                            <br> Navegadores Recomendados : 
                            <img style="margin-left: 10px;" src="assets/img/chrome.png" width="30"> 
                            <img style="margin-left: 10px;" src="assets/img/firefox.png" width="30">                     
                        </div>
                    </div>
                </div>
            </div>
