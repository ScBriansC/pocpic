...
function get_ws($parametro, $his = false){
	...
	$ws = @file_get_contents('http://192.168.11.23/ws_vehiculos/Api?_sKey=RDO_X1485PU75634&_sAcc=dta_rdo_loc&_sID='.$_id);
...
function getID(){
	$ws = @file_get_contents('http://192.168.11.23/ws_vehiculos/Api?_sKey=RDO_X1485PU75634&_sAcc=dta_rdo_locid');
	return $ws;
}
